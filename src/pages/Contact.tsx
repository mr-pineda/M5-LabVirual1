    ...
    <Container fluid className="contact-container">
      <Row>
        ...
        <Col md={6} className="form-column">
          <h2 style={{margin: '20px'}}>Contáctanos</h2>
          <Form>
          ...
          <p style={{margin: '20px'}}>Ginecología y Obstetricia Anexo 104</p>
...
<Col md={6} className="map-column">
  ...
  <div className="map-container" style={{ height: '450px', width: '100%', margin: '20px' }}>
    <iframe
